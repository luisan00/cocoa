...
TEST_CASE("Test vector 1", tag)
{
    ...
    res = hdnode_deserialize_public(chain_m2_xpub, MAIN_VERSION_PUBLIC, SECP256K1_NAME, &node2, NULL);
    if (res != 0)
    {
        TEST_LOGE("Deserialize xpub", "no error", "error");
    }
    ...
    res = hdnode_deserialize_public(chain_m3_xpub, MAIN_VERSION_PUBLIC, SECP256K1_NAME, &node2, NULL);
    if (res != 0)
    {
        TEST_LOGE("Deserialize xpub", "no error", "error");
    }
    ...
    res = hdnode_deserialize_public(chain_m4_xpub, MAIN_VERSION_PUBLIC, SECP256K1_NAME, &node2, NULL);
    if (res != 0)
    {
        TEST_LOGE("Deserialize xpub", "no error", "error");
    }
